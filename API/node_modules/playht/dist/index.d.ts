 ...
 * to `PlayHT2.0`, and `voice` uses that engine.
 */
export type Play30EngineStreamOptions = Omit<PlayHT20EngineStreamOptions, 'voiceEngine' | 'emotion' | 'outputFormat'> & {
    /**
 ...
 */
export type PlayDialogEngineStreamOptions = Omit<Play30EngineStreamOptions, 'voiceEngine' | 'quality' | 'styleGuidance' | 'textGuidance' | 'voiceGuidance'> & {
    /**
 ...
 */
export type PlayDialogTurboEngineStreamOptions = Omit<Play30EngineStreamOptions, 'voiceEngine' | 'outputFormat' | 'seed' | 'sampleRate' | 'temperature' | 'quality' | 'styleGuidance' | 'textGuidance' | 'voiceGuidance' | 'language'> & {
    /**
    ...
    language?: 'english';
    voiceId: 'Arista-PlayAI' | 'Atlas-PlayAI' | 'Basil-PlayAI' | 'Briggs-PlayAI' | 'Calum-PlayAI' | 'Celeste-PlayAI' | 'Cheyenne-PlayAI' | 'Chip-PlayAI' | 'Cillian-PlayAI' | 'Deedee-PlayAI' | 'Fritz-PlayAI' | 'Gail-PlayAI' | 'Indigo-PlayAI' | 'Mamaw-PlayAI' | 'Mason-PlayAI' | 'Mikail-PlayAI' | 'Mitch-PlayAI' | 'Quinn-PlayAI' | 'Thunder-PlayAI';
});
/**
 ...
 * options.
 */
export type SpeechStreamOptions = SharedSpeechOptions & (PlayDialogTurboEngineStreamOptions | PlayDialogEngineStreamOptions | Play30EngineStreamOptions | PlayHT20EngineStreamOptions | PlayHT10EngineStreamOptions | StandardEngineOptions);
/**
...
export declare const cache: {
     ...
     */
    clearInferenceCoordinatesStoreForUser: (userId: import("./api/internal/types").UserId) => void;
};
